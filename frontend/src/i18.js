    ...
    resources: {
      en: {
        translation: {
          ...
          "fixErrorsMessage": "Please fix the errors above before continuing",
          "errorLoggingIn": "Something went wrong while logging in. Please try again.",
          "userCreated": "Account created successfully",
          "errorCreatingUser": "Error creating account. Please try again.",
          ...
          "Edit task": "Edit task",
          "Edit Task": "Edit Task",
          "errorTitle": "Title must be at least 2 characters long",
          "errorDescription": "Description must be at least 5 characters long",
          "errorDateFinish": "Due date must be in the future",
          "taskErrorTitle": "Title must be at least 2 characters long",
          "taskErrorDescription": "Description must be at least 5 characters long",
          "taskErrorDateFinish": "Due date must be in the future",
          "taskCreated": "Task created successfully",
          "errorCreatingTask": "Error creating task. Please try again.",
          "errorFetchingTask": "Error fetching task data.",
          "failedToFetchTaskData": "Failed to fetch task data.",
          ...
          "Failed to mark project as completed. Please try again.": "Failed to mark project as completed. Please try again.",
          ...
          "errorFetchingProject": "Error fetching project data.",
          "failedToFetchProjectData": "Failed to fetch project data.",
          "projectErrorTitle": "Title must be at least 2 characters long",
          "projectErrorDescription": "Description must be at least 5 characters long",
          "projectErrorDateFinish": "Due date must be in the future",
      ...
      es: {
        translation: {
          ...
          "incorrectEmailFormat": "Introduce un correo electrónico válido",
          "passwordTooShort": "La contraseña debe tener al menos 5 caracteres",
          "fixErrorsMessage": "Corrige los errores antes de continuar",
          "errorLoggingIn": "Ocurrió un error al iniciar sesión. Inténtalo de nuevo.",
          "userCreated": "Cuenta creada correctamente",
          "errorCreatingUser": "Error al crear la cuenta. Inténtalo de nuevo.",
          ...
          "selectDueDate": "Selecciona la fecha de vencimiento",
          "low": "Baja",
          "medium": "Media",
          "high": "Alta",
          "pending": "Pendiente",
          ...
          "Edit Task": "Editar Tarea",
          "errorTitle": "El título debe tener al menos 2 caracteres",
          "errorDescription": "La descripción debe tener al menos 5 caracteres",
          "errorDateFinish": "La fecha de vencimiento debe ser futura",
          "taskErrorTitle": "El título debe tener al menos 2 caracteres",
          "taskErrorDescription": "La descripción debe tener al menos 5 caracteres",
          "taskErrorDateFinish": "La fecha de vencimiento debe ser futura",
          "taskCreated": "Tarea creada correctamente",
          "errorCreatingTask": "Error al crear la tarea. Inténtalo de nuevo.",
          "errorFetchingTask": "Error al obtener los datos de la tarea.",
          "failedToFetchTaskData": "No se pudieron obtener los datos de la tarea.",
          "taskUpdatedSuccessfully": "Tarea actualizada correctamente",
          "failedToUpdateTask": "No se pudo actualizar la tarea.",
          "errorUpdatingTask": "Error al actualizar la tarea. Inténtalo de nuevo.",
          "confirmDeleteTask": "¿Seguro que quieres eliminar esta tarea?",
          "Failed to mark project as completed. Please try again.": "Error al marcar el proyecto como completado. Inténtalo de nuevo.",

          "projectTitle": "Título del proyecto",
          "projectDescription": "Descripción del proyecto",
          "projectDueDate": "Fecha de vencimiento del proyecto",
          "createProject": "Crear proyecto",
          "Add subtask": "Añadir subtarea",
          "subtask": "Subtarea",
          "Progress:": "Progreso:",
          "projectCreated": "Proyecto creado correctamente",
          "errorCreatingProject": "Error al crear el proyecto. Inténtalo de nuevo.",
          "errorFetchingProject": "Error al obtener los datos del proyecto.",
          "failedToFetchProjectData": "No se pudieron obtener los datos del proyecto.",
          "projectErrorTitle": "El título debe tener al menos 2 caracteres",
          "projectErrorDescription": "La descripción debe tener al menos 5 caracteres",
          "projectErrorDateFinish": "La fecha de vencimiento debe ser futura",
          "invalidDueDate": "Fecha de vencimiento no válida",
          "projectUpdatedSuccessfully": "Proyecto actualizado correctamente",
          "failedToUpdateProject": "No se pudo actualizar el proyecto.",
          "Edit project": "Editar proyecto",
          "confirmDeleteProject": "¿Seguro que quieres eliminar este proyecto?",
        }
      },
      fr: {
        translation: {
